...
const App: React.FC = () => {
  ...
  const initializeInterview = useCallback(async (text: string) => {
    setResumeText(text);
    ...
    try {
      ...
      const firstPrompt = `Here is the candidate's resume. Please review it and then start the interview by introducing yourself and asking the first question. Resume:\n\n${text}`;
